        ...
        <div className="flex h-screen items-center justify-center  bg-slate-900">
            <form onSubmit={handleSubmit(onSubmit)} className="border border-white px-6 py-2 rounded-md space-y-3 w-96">
                ...
                <label className="input input-bordered flex items-center gap-2">
                    ...
                    <input type="email" className="grow" placeholder='Enter your Email' {...register("email", { required: true })} />
                </label>
                {errors.email && <span className="text-red-500 text-sm font-semibold">Enter valid Email address</span>}
